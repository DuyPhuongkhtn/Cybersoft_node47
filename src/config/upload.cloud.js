...
const storage = new CloudinaryStorage({
    cloudinary,
    params: {
        folder: 'avatar', //define folder lưu hình, nếu cloudinary ko có thì sẽ tạo folder mới
        ...
        public_id: (req, file) => {
            const newName = new Date().getTime() + "_" + file.originalname.split(".")[0];            return newName;
        }
    }
});
